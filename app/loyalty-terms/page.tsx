...
export const metadata: Metadata = {
  ...
  description: 'Правила начисления и списания бонусных баллов, уровни программы, реферальная программа КраскаПроф.',
}
    ...
    <div className="mx-auto max-w-3xl px-4 py-12 md:px-6">
      ...
      <div className="flex flex-col gap-6 text-foreground leading-relaxed text-sm">
        <section>
          ...
          <p>
            Программа лояльности КраскаПроф — система накопительных бонусных баллов для

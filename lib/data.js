...
export var BASE_BONUS_RATE = 0.03;
/** Расчёт базовых бонусных баллов за товар. */
export function bonusFor(price, rate) {
    if (rate === void 0) { rate = BASE_BONUS_RATE; }
    return Math.round(price * rate);
}
var WHITE = { hex: "#F4F4F0", name: "Белый" };
var PALETTE = [
...
export var products = [
    {
        ...
        description: "Высококачественная водоэмульсионная краска для стен и потолков. Создаёт ровное матовое покрытие, устойчивое к влажной уборке. Не содержит растворителей и практически без запаха, что делает её безопасной для жилых помещений.",
        specs: {
        ...
        application: "Поверхность очистить от пыли и загрязнений, при необходимости загрунтовать. Краску тщательно перемешать. Наносить валиком или кистью в 1–2 слоя с интервалом 2–4 часа.",
    },
    {
        id: "p2",
        ...
        description: "Акриловая фасадная краска для наружных работ. Устойчива к УФ-излучению, осадкам и перепадам температур. Паропроницаемое покрытие защищает фасад и сохраняет цвет до 10 лет.",
        specs: {
        ...
        application: "Наносить на сухую очищенную поверхность при температуре не ниже +5 °C. Рекомендуется предварительное грунтование. Два слоя с интервалом 4–6 часов.",
    },
    {
        id: "p3",
        ...
        description: "Грунтовка глубокого проникновения укрепляет рыхлые и пористые основания, улучшает адгезию и снижает расход финишных покрытий. Подходит для внутренних и наружных работ.",
        specs: {
        ...
        application: "Наносить кистью, валиком или распылителем на очищенную поверхность. При сильно впитывающих основаниях нанести повторно.",
    },
    {
        id: "p4",
        ...
        description: "Универсальная алкидная эмаль для наружных и внутренних работ по металлу и дереву. Образует прочное глянцевое покрытие, устойчивое к атмосферным воздействиям.",
        specs: {
        ...
        application: "Поверхность очистить и обезжирить. Металл предварительно загрунтовать. Наносить кистью или распылителем в 2 слоя.",
    },
    {
        id: "p5",
        slug: "anticor-3in1",
        ...
        description: "Грунт-эмаль 3 в 1 совмещает функции преобразователя ржавчины, грунта и декоративного покрытия. Наносится прямо на очищенную ржавую поверхность без дополнительной подготовки.",
        specs: {
        ...
        application: "Удалить рыхлую ржавчину металлической щёткой, обезжирить. Наносить в 2–3 слоя с интервалом 3–4 часа.",
    },
    {
        id: "p6",
        ...
        description: "Огнебиозащитный состав для древесины обеспечивает I группу огнезащитной эффективности и защиту от плесени, грибка и насекомых. Не изменяет структуру древесины.",
        specs: {
        ...
        application: "Наносить на сухую очищенную древесину при влажности не более 20%. 2–3 слоя с интервалом 30–60 минут.",
    },
    {
        id: "p7",
        ...
        description: "Специальная краска для помещений с повышенной влажностью. Образует покрытие с защитой от плесени и грибка, выдерживает частую влажную уборку.",
        specs: {
        ...
        application: "Наносить на подготовленную загрунтованную поверхность в 2 слоя валиком или кистью.",
    },
    {
        id: "p8",
        ...
        description: "Паркетный лак на водной основе для деревянных полов с высокой проходимостью. Создаёт износостойкое полуматовое покрытие, не желтеет со временем.",
        specs: {
        ...
        application: "Наносить на очищенную отшлифованную древесину кистью или валиком в 2–3 слоя с промежуточной шлифовкой.",
    },
    {
        id: "p9",
        ...
        description: "Силиконовая фасадная краска с грязеотталкивающим эффектом. Высокая паропроницаемость и водоотталкивающие свойства обеспечивают длительную защиту фасада.",
        specs: {
        ...
        application: "Наносить на сухую загрунтованную поверхность в 2 слоя при температуре +5…+30 °C.",
    },
    {
        id: "p10",
        ...
        description: "Адгезионный грунт с кварцевым наполнителем для создания шероховатой основы на гладких плотных поверхностях перед штукатуркой или плиткой.",
        specs: {
        ...
        application: "Тщательно перемешать. Наносить кистью или валиком одним слоем. Последующие работы через 3–4 часа.",
    },
    {
        id: "p11",
        ...
        description: "Термостойкая эмаль для отопительных приборов. Выдерживает нагрев до +90 °C, сохраняет белизну и не желтеет при эксплуатации.",
        specs: {
        ...
        application: "Радиатор очистить, обезжирить. Наносить на холодную поверхность в 2 слоя.",
    },
    {
        id: "p12",
        ...
        description: "Битумно-полимерная гидроизоляционная мастика для защиты фундаментов, кровли и подвалов от влаги. Образует бесшовное эластичное покрытие.",
        specs: {
        ...
        application: "Основание очистить и просушить. Наносить кистью или шпателем в 2 слоя с промежуточной сушкой.",
    },
];
export var blogPosts = [
    {
        ...
        excerpt: "Разбираемся, чем отличаются водоэмульсионные, акриловые и алкидные краски и что выбрать для разных комнат.",
        cover: "#9DB4C0",
        date: "2026-06-05",
        readingTime: 7,
        content: "Выбор краски начинается с типа помещения и поверхности. Для сухих жилых комнат подойдёт водоэмульсионная матовая краска — она безопасна и легко наносится. Для кухни и ванной нужна влагостойкая акриловая краска с защитой от плесени. Для деревянных и металлических поверхностей используют алкидные эмали.\n\nОбращайте внимание на расход: качественная краска перекрывает основание за два слоя, что в итоге экономнее дешёвых аналогов. Не забудьте про грунтовку — она укрепляет основание и снижает расход финишного покрытия.",
    ...
    },
    {
        ...
        excerpt: "Тёплые землистые оттенки, приглушённый индиго и природная зелень — что в моде в этом сезоне.",
        cover: "#7C8B4F",
        date: "2026-05-20",
        readingTime: 5,
        content: "В 2026 году дизайнеры делают ставку на природные и спокойные оттенки. Землистая терракота, оливковый и приглушённый индиго создают уютную и одновременно современную атмосферу.\n\nСоветуем использовать колеровку, чтобы точно попасть в модный оттенок по каталогам RAL и NCS. Комбинируйте насыщенный акцентный цвет на одной стене с нейтральным фоном на остальных.",
    ...
    },
    {
        ...
        category: "Инструкции",
        excerpt: "Правильная подготовка — половина успеха. Рассказываем, как подготовить фасад, чтобы краска держалась годами.",
        cover: "#C05746",
        date: "2026-04-15",
        readingTime: 6,
        content: "Перед покраской фасада поверхность нужно очистить от грязи, старой отслаивающейся краски и высолов. Трещины расшить и заделать, поверхность выровнять.\n\nОбязательный этап — грунтование. Оно укрепляет основание и улучшает адгезию краски. Красить лучше в сухую погоду при температуре не ниже +5 °C, избегая прямого солнца.",
        relatedProductSlugs: [
            "facade-acryl-fasad",
            "facade-silicone",
            "primer-deep-grunt",
...
export function getProductsByCategory(categorySlug) {
    return products.filter(function (p) { return p.categorySlug === categorySlug; });
}
export function getRelatedProducts(product, limit) {
    if (limit === void 0) { limit = 4; }
    return products
        .filter(function (p) { return p.categorySlug === product.categorySlug && p.id !== product.id; })
        .slice(0, limit);
}
export function getAccessories(limit) {
    if (limit === void 0) { limit = 4; }
    // ponytail: аксессуаров в каталоге нет — показываем грунтовки/спецсоставы как сопутствующие.
    return products
        .filter(function (p) { return p.categorySlug === "primer" || p.categorySlug === "special"; })
        .slice(0, limit);
}
export function getCategoryBySlug(slug) {
    return categories.find(function (c) { return c.slug === slug; });
}
export var HITS = products.filter(function (p) { return p.badges.includes("Хит"); });
